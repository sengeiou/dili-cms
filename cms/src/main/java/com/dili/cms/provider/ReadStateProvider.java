 ...
 * <p>
 * ReadStateProvider created on 2021/1/26 15:58 by Ron.Peng
 */
...
@Component
@Scope("prototype")
public class ReadStateProvider implements ValueProvider {
    private static final List<ValuePair<?>> BUFFER = new ArrayList<>();

    static {
        BUFFER.addAll(Stream.of(ReadType.values())
