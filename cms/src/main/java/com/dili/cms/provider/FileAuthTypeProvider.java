 ...
 * <p>
 * FileAuthTypeProvider created on 2021/1/26 20:31 by Ron.Peng
 */
...
@Component
@Scope("prototype")
public class FileAuthTypeProvider implements ValueProvider {
    private static final List<ValuePair<?>> BUFFER = new ArrayList<>();

    static {
        BUFFER.addAll(Stream.of(FileAuthType.values())
